...
import 'package:hm_shop/models/tab_list_item.dart';
...
class _MainPageStateState extends State<MainPage> {
  ...
  //   },
  // ];
  final List<TabListItem> _tableList = [
    TabListItem(icon: "lib/assets/ic_public_home_normal.png", activeIcon: "lib/assets/ic_public_home_active.png", text: "首页"),
    TabListItem(icon: "lib/assets/ic_public_pro_normal.png", activeIcon: "lib/assets/ic_public_pro_active.png", text: "分类"),
    TabListItem(icon: "lib/assets/ic_public_cart_normal.png", activeIcon: "lib/assets/ic_public_cart_active.png", text: "购物车"),
    TabListItem(icon: "lib/assets/ic_public_my_normal.png", activeIcon: "lib/assets/ic_public_my_active.png", text: "我的")
